            ...
            <section class="mb-12">
                <div class="relative rounded-xl overflow-hidden h-64 sm:h-80 md:h-96 bg-gradient-to-r from-indigo-500 to-indigo-700">
                    ...
                    <div class="absolute inset-0 flex flex-col justify-center items-center text-white p-6 text-center">
                        <h1 class="font-display text-3xl sm:text-4xl md:text-5xl font-bold mb-4 tracking-tight">Your Glamour Radar</h1>
                        <p class="text-base sm:text-lg md:text-xl max-w-2xl mb-6">Discover fashion inspiration from bloggers, customers, and style enthusiasts. Upload photos to find similar looks and shop the styles you love.</p>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 items-center">
                            ...
                            <p class="text-sm sm:text-base opacity-90">Upload a photo to find similar fashion items</p>
                        </div>
                    </div>
                </div>
            </section>
